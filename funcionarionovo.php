						...
						<li class="has-submenu active">
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										<h4>Escolha abaixo</h4>
										<ul>
											<li><a href="listarfuncionarios.php">Funcion&aacuterios</a></li>
											<li><a href="listarmaquinas.php">M&aacutequina</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										<h4>Escolha abaixo</h4>
										<ul>
											<li><a href="cadastrarFuncionario.html">Funcion&aacuterios</a></li>
											<li><a href="cadastrarFabricante.html">Fornecedor</a></li>
											<li><a href="page-404.html">M&aacutequina</a></li>
										</ul>
